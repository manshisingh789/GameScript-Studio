...
/* package lumenscript-studio-0.1.0.0 */
#ifndef VERSION_lumenscript_studio
#define VERSION_lumenscript_studio "0.1.0.0"
#endif /* VERSION_lumenscript_studio */
#ifndef MIN_VERSION_lumenscript_studio
#define MIN_VERSION_lumenscript_studio(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lumenscript_studio */
...
#define CURRENT_COMPONENT_ID "lumenscript-studio-0.1.0.0-6OjGpmhGXDO1TgBYJyVeGD-lumenscript-studio-test"
