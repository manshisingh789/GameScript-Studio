...
- `src/`: Contains the core source code for the language.
  ...
  - `Semantic/`: Performs type checking and validation (currently a scaffold).
  - `Bytecode/`: Compiles the AST to bytecode.
  - `VM/`: The virtual machine that executes bytecode.
  - `GUI/`: A scaffold for the future graphical user interface.
  - `Simulation/`: A scaffold for the future game simulation engine.
